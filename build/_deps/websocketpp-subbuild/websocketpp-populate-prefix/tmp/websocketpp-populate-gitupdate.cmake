...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "0.8.2"
  WORKING_DIRECTORY "/home/user/Documentos/Wellington/Lab/RoKet/MITM/Zapdos/build/_deps/websocketpp-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 0.8.2")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"0.8.2\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/user/Documentos/Wellington/Lab/RoKet/MITM/Zapdos/build/_deps/websocketpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/user/Documentos/Wellington/Lab/RoKet/MITM/Zapdos/build/_deps/websocketpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
